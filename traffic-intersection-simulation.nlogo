...
to setup
  ...
  ask patches [
    ifelse abs pxcor <= 1 or abs pycor <= 1
      [ set pcolor grey ]    ; the roads are grey
...
"" ""
PENS
"overall" 1.0 0 -16777216 true "" "plot count cars"
"eastbound" 1.0 0 -13345367 true "" "plot count cars with [ heading = 90]"
"northbound" 1.0 0 -2674135 true "" "plot count cars with [ heading = 0]"
...
855
275
count cars-eastbound
count cars with [ heading = 90 ]
17
1
11
...
855
325
count cars-northbound
count cars with [ heading = 0 ]
17
1
11
...
"" ""
PENS
"overall" 1.0 0 -16777216 true "" "plot count cars with [ speed > 0 ] / count cars"
"eastbound" 1.0 0 -13345367 true "" "plot count cars with [ heading = 90 and speed > 0 ] / count cars with [ heading = 90 ]"
"northbound" 1.0 0 -2674135 true "" "plot count cars with [ heading = 0 and speed > 0 ] / count cars with [ heading = 0 ]"
...
count cars with [ speed > 0 ] / count cars
2
1
11
...
855
445
average speed-eastbound
count cars with [ heading = 90 and speed > 0 ] / count cars with [ heading = 90 ]
2
1
11
...
855
495
average speed-northbound
count cars with [ heading = 0 and speed > 0 ] / count cars with [ heading = 0 ]
2
1
11
